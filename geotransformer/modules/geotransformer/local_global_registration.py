...
class LocalGlobalRegistration(nn.Module):
    def __init__(
        ...
        self.robust_refinement_radius = None
    ...
    def recompute_correspondence_scores(self, ref_corr_points, src_corr_points, corr_scores, estimated_transform):
        ...
        if self.robust_refinement_radius is not None:
            new_corr_scores = new_corr_scores / (1.0 + (corr_residuals / self.robust_refinement_radius).square())
